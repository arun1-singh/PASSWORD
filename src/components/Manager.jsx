...
const Manager = () => {
    ...
    return (
        <>
            ...
            <div className="absolute inset-0 -z-10 h-full w-full bg-green-50 bg-[linear-gradient(to_right,#8080800a_1px,
transparent_1px),linear gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px]">
            ...
            <div className="p-3 md:mycontainer min-h-[88.2vh]">
                <h1 className='text-4xl text font-bold text-center' >   <span className='bg-green-700'> &lt;</span>
                ...
                <div className="flex flex-col p-4 text-black gap-8 items-center">
                    ...
                    <div className="flex flex-col md:flex-row w-full justify-between gap-8">
                        ...
                        <div className='relative'>
                            <input value={form.password} ref={passwordRef} onChange={handleChange} placeholder='Enter Password' className='rounded-full border border-green-500 w-full p-4 py-1' type="password" name="password" id="password" />
                    ...
                    <button onClick={savePassword} className='flex justify-center item-center gap-2 bg-green-400 hover:bg-green-300 rounded-full px-8 py-2 w-fit border border-green-900'>
                        <lord-icon
